...
PRODUCT_COPY_FILES += \
    ...
    $(COMMON_FOLDER)/configs/audio/eos_front_audio_config.conf:system/etc/huawei/audio/full_front_audio_config.conf \
...
# if ro.build.display.id is such "eos_front-userdebug 4.2.2 JDQ39E eng.shev.20130805.153138 test-keys" then gellry crashshshsh
